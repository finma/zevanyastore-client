...
export const Footer: VFC = () => {
  return (
    <footer className="pt-4 xl:pt-8 pb-8 bg-pastel-blue-light dark:bg-gray-800">
      <div className="px-4 sm:px-6 md:px-8 mx-auto max-w-screen-lg xl:max-w-screen-xl text-gray-500 dark:text-gray-300">
        ...
        <div className="flex justify-center items-center pt-8 mx-auto space-x-12 max-w-xs text-gray-800 border-t border-gray-200">
          <Link href="/">
            <a>
              <svg
                ...
                height="25"
                fill="currentColor"
                className="text-xl hover:text-pastel-pink-dark dark:hover:text-white transition-colors duration-200"
          ...
          <Link href="https://github.com/finma/online-shop-fe">
