...
export const Footer: VFC = () => {
  return (
    <footer className="pt-4 xl:pt-8 pb-8 dark:bg-gray-800 bg-pastel-blue-light">
      <div className="px-4 sm:px-6 md:px-8 mx-auto max-w-screen-lg xl:max-w-screen-xl text-gray-500 dark:text-gray-300">
        <ul className="flex flex-wrap justify-center pb-8 text-lg font-light">
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className=" text-center text-gray-800">
              ...
              <ul>
                <li className="mb-4 dark:hover:text-white transition-colors duration-200 hover:text-pastel-pink-dark">
                  <Link href="/">
                    <a>Bantuan</a>
                  </Link>
                </li>
          ...
          <Link href="/">
            <a>
              <svg
                ...
                height="25"
                fill="currentColor"
                className="text-xl dark:hover:text-white transition-colors duration-200 hover:text-pastel-pink-dark"
        ...
        <div className="flex justify-center items-center pt-10 sm:pt-12 font-light text-center">
          &copy; 2021 Zevanyastore. All Right Reserved
        </div>
      </div>
    </footer>
  );
